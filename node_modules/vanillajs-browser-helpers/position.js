...
var isDocument_1 = __importDefault(require("./isDocument"));
var scrollInfo_1 = __importDefault(require("./scrollInfo"));
var size_1 = __importDefault(require("./size"));
var getWindowPosition = function (win) {
    var top = win.screenLeft || win.screenX || 0;
    var left = win.screenY || win.screenTop || 0;
    var right = win.screen.availWidth - left - win.outerWidth;
    var bottom = win.screen.availHeight - top - win.outerHeight;
    return { top: top, left: left, right: right, bottom: bottom };
};
var getElementPosition = function (elm) {
    var rect = elm.getBoundingClientRect();
    var vpScroll = (0, scrollInfo_1.default)();
    var vpSize = (0, size_1.default)();
    var elmSize = (0, size_1.default)(elm);
    var parentSize = (0, size_1.default)(elm.offsetParent || undefined);
    return {
