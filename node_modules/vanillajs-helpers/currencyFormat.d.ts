export declare type CurrencyFomatter = (num: number) => string;
/**
 ...
 */
export declare function currencyFormat(thousandString?: string): CurrencyFomatter;
declare const _default: CurrencyFomatter;
