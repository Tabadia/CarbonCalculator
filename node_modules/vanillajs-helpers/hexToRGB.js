...
var chunkString_1 = __importDefault(require("./chunkString"));
...
function hexToRGB(hex) {
    ...
    var rgb = (0, chunkString_1.default)(hex, hex.length <= 4 ? 1 : 2)
        .map(function (c) { return (0, hexToNumber_1.default)(c.length > 1 ? c : "".concat(c).concat(c)); });
    if (rgb.length > 3) {
